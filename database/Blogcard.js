export const BlogData = [
  ...
  },
  {
    ...
    description:
      "Embark on a scientific odyssey and unravel the mysteries of the universe, from the microscopic realm of atoms to the vast expanse of galaxies.",
    publishing_date: "November 19, 2023",
    category: "Science",
  },
  {
    id: 8,
    ...
    description:
      "Step into the wilderness and witness the incredible diversity of wildlife, from majestic creatures of the savannah to elusive species thriving in remote ecosystems.",
    publishing_date: "December 8, 2023",
    category: "Nature",
  },
  {
    id: 9,
    ...
    description:
      "Immerse yourself in the world of artistic expression, where colors, shapes, and forms come together to evoke emotions and inspire the imagination.",
    publishing_date: "January 17, 2024",
    category: "Art",
  },
  {
    id: 10,
    ...
    description:
      "Travel back in time and unravel the stories of ancient civilizations, momentous events, and the remarkable individuals who shaped the course of history.",
    publishing_date: "February 25, 2024",
    category: "History",
  },
  {
    id: 11,
    ...
    description:
      "Discover the key elements of holistic well-being and embark on a journey towards a balanced and healthy lifestyle, encompassing mind, body, and soul.",
    publishing_date: "March 9, 2024",
    category: "Health",
  },
  {
    id: 12,
    ...
    description:
      "Delve into the advancements of artificial intelligence and explore how it is transforming industries, revolutionizing technology, and redefining the way we live.",
    publishing_date: "April 22, 2024",
    category: "Technology",
  },
  {
    id: 13,
    ...
    description:
      "Embark on a virtual journey to breathtaking destinations, hidden gems, and extraordinary cultures as we bring you captivating travel stories from across the globe.",
    publishing_date: "May 5, 2024",
    category: "Travel",
  },
  {
    id: 14,
    ...
    description:
      "Unveil the wonders of the cosmos and join the intrepid explorers in their quest to understand the universe, from distant galaxies to the mysteries of dark matter.",
    publishing_date: "June 18, 2024",
    category: "Science",
  },
  {
    id: 15,
    ...
    description:
      "Embark on a gastronomic journey as we indulge in a medley of cuisines, traditional delicacies, and culinary traditions that make every bite an unforgettable experience.",
    publishing_date: "July 2, 2024",
    category: "Food",
  },
];
